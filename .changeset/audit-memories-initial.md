---
"@zcaceres/skill-audit-memories": minor
---

Add `audit-memories`: a guided review for an AI agent's saved memories. Default
...
code citation against the *current* repo before flagging, so a correct
