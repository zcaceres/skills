...
- Preferred: open a [GitHub private security advisory](https://github.com/zcaceres/skills/security/advisories/new).
- Alternatively, email **anthropic@zach.dev** with details and, if possible,
