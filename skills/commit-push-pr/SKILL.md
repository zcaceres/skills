---
name: commit-push-pr
description: Commit your conversation changes, push, and open a PR. Stack-aware — uses git stack submit on stacked branches, else gh pr create. Preserves the existing base branch. Invoke via /commit-push-pr.
