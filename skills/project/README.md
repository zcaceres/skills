...
| `milestone <create\|add\|next\|list>` | Group work into a milestone (a github milestone / a linear project): create one, add a card, run a `next`-style pick scoped to it, or list milestones. |
