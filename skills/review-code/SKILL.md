---
name: review-code
description: Review the current branch diff and report bugs as structured inline-style findings. Use when the user says "review code", "review my changes", "code review", "review this diff", or "/review-code".
---
